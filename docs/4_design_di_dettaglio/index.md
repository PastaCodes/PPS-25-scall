...
* $\mathrm{FIRST}(X_1X_2\hspace{-3mu}\cdots\hspace{-3mu}X_n) \supseteq \mathrm{FIRST}(X_1) \setminus \lbrace\, \varepsilon \,\rbrace$.
* Se&ensp;$\varepsilon\in\mathrm{FIRST}(X_1)$&ensp;allora&ensp;$\mathrm{FIRST}(X_1X_2\hspace{-3mu}\cdots\hspace{-3mu}X_n) \supseteq \mathrm{FIRST}(X_2\hspace{-3mu}\cdots\hspace{-3mu}X_n)$.
