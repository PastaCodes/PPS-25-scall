...
* $\mathrm{FIRST}(X_1X_2\hspace{-3mu}\cdots\hspace{-3mu}X_n) = \lbrace\, b \mid X_1X_2\hspace{-3mu}\cdots\hspace{-3mu}X_n \Rightarrow^* b\,\alpha \,\rbrace \;\cup\; \lbrace\, \varepsilon \mid X_1X_2\hspace{-3mu}\cdots\hspace{-3mu}X_n \Rightarrow^* \varepsilon \,\rbrace$&ensp;dove $X_1X_2\hspace{-3mu}\cdots\hspace{-3mu}X_n$ è una stringa di simboli.
